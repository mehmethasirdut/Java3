...
public class _06_SayiKelime {
    public static void main(String[] args) {
        ...
        String girilenkelime="500";
        int girilensayi=Integer.parseInt(girilenkelime); // Stringi integer a çevirdik
        System.out.println(girilensayi);

        int toplams=girilensayi+girilensayi; // integer değerlerin toplamı
        System.out.println(toplams);

        String toplam1=girilenkelime+girilenkelime; // string değerlerin toplamı
        System.out.println(toplam1);

        String girilens=Integer.toString(girilensayi); // geri stringe çevirdik
